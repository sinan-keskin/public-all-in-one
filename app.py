...
st.markdown(
    """
    <div style='text-align:center; opacity:.9; display:flex; justify-content:center; align-items:center; gap:20px; flex-wrap:wrap;'>
        ...
        <!-- Instagram -->
        <a href='https://instagram.com/sinankeeeee' target='_blank' style='color:inherit; text-decoration:none;'>
            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="currentColor" style="vertical-align:middle;">
                <path d="M7 2C4.24 2 2 4.24 2 7v10c0 2.76 2.24 5 5 5h10c2.76 0 5-2.24 5-5V7c0-2.76-2.24-5-5-5H7zm10 2c1.65 0 3 1.35 3 3v10c0 1.65-1.35 3-3 3H7c-1.65 0-3-1.35-3-3V7c0-1.65 1.35-3 3-3h10zm-5 3a5 5 0 1 0 0 10 5 5 0 0 0 0-10zm0 2a3 3 0 1 1 0 6 3 3 0 0 1 0-6zm4.8-.9a1.1 1.1 0 1 0 0-2.2 1.1 1.1 0 0 0 0 2.2z"/>
            </svg>
        </a>

        <!-- Telegram -->
        <a href='https://t.me/sinankeeeee' target='_blank' style='color:inherit; text-decoration:none;'>
            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="currentColor" style="vertical-align:middle;">
                <path d="M9.04 15.81 8.8 19.34c.47 0 .68-.2.93-.44l2.24-2.13 4.65 3.38c.85.47 1.47.22 1.7-.79l3.09-14.38c.28-1.3-.46-1.8-1.3-1.49L2.4 9.67c-1.27.49-1.26 1.18-.22 1.49l4.47 1.4 10.38-6.56c.49-.31.94-.14.57.2L9.04 15.81z"/>
            </svg>
        </a>
    </div>
